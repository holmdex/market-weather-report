  ...
  layout(
    title = list(
      text = paste0(
        ...
        "<br>",
        "<sup>Double-Click on market names to see through the fog! 🔍</sup>"
      ),
    ...
    margin = list(l = 60, r = 60, t = 80, b = 100),
    height = 550,
    showlegend = TRUE,
    legend = list(
      orientation = "h",
...
forecasts <- monthly_data %>%
  ...
  group_modify(~{
    ...
    ts_data <- ts(.x$norm_price, frequency = 7)  # Changed to norm_price
  ...
  layout(
    title = list(
      text = paste0(
        ...
        "<br>",
        "<sup>Double-Click on market names to see each market's potential future path! 🔮</sup>"
      ),
      font = list(size = 20, color = "black"),
      y = 0.95
    ),
